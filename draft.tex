...
\usepackage[tmargin=2.3cm, hmargin=2.5cm, bmargin=2.3cm]{geometry}
\usepackage{hyperref}
\usepackage{fontspec}
...
\begin{titlepage}
    ...
    \begingroup
        \footnotetext[1]{This word-count was computed by \texttt{texcount -sum -1 content.tex}.}
    ...
    \section{Category theory} \label{sec: cat}
        ...
        \subsection{Cartesian closed category}
            ...
            \begin{definition}[Exponential]
                ...
                \begin{equation}
                    \vcenter{\hbox{\includegraphics[width=0.3\textwidth]{exponential.pdf}}}
...
\chapter{Implementation} \label{chap: implementation}
    ...
    In the standard library~\autocite{agda_std}, the subtraction of natural numbers is defined as follows:\footnote{The definition in the standard library directly uses symbol $\mathsf{-}$, but here for clarity I use $\mathsf{\dotdiv}$ instead.}
...
\chapter{Operational Semantics of the source language} \label{app: operational_semantics}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=1.2]{/appendix/source_operational_semantics_1.pdf}
        \caption{Operational semantics of the source language (Part 1)}
        \label{fig: operational_semantics_1}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[scale=1.2]{/appendix/source_operational_semantics_2.pdf}
...
\chapter{Properties of target language} \label{app: target_properties}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=1.2]{/appendix/target_properties.pdf}
...
\chapter{Compiler details} \label{app: compiler_details}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=1.2]{/appendix/new_var.pdf}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=1.2]{/appendix/use_temp.pdf}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=1.2]{/appendix/new-intvar.pdf}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=1.2]{/appendix/assign.pdf}
        \caption{Assignment}
        \label{fig: assign}
    \end{figure}


% \chapter{Test cases} \label{app: test_cases}
%     The test cases are defined as follows:
%     \begin{figure}[H]
%         \centering
%         \includegraphics[scale=1.2]{/appendix/test_1.pdf}
%         \caption{Test cases}
